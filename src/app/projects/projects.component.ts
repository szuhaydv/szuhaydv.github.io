...
export class ProjectsComponent {
  ...
  projectsData = [
    ...
    new Project(3, 'assets/encrypt.png', 'Encryption (self-written)', "Self written encryption and decryption protocol", ["React", "API Calls", "Auth"], false,
    ...
    new Project(4, 'assets/newportfolio.png', 'Modern Portfolio', "This is where you are currently!", ["Angular", "Deployed"], true,
    ...
    new Project(5, 'assets/spacespice.png', 'Space-Spice', "A recipe search website concept for a small restaurant", ["React", "API Calls", "Deployed"], true,
