...
export class MainComponent {
  ...
  latestProjects = [
    ...
    new Project(0, 'assets/rankmaster-web.png', 'RankMaster', 'Tierlist minigame with constant daily challenges and unlockable levels!', ["Angular", "Deployed", "Responsive", "API Calls", "Full Stack", "Database", "Auth"], true,
